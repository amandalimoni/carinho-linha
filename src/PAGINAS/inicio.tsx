...
const DADOS_DO_GRUPO = {
  ...
  videoYouTube: "<iframe width="560" height="315" src="https://www.youtube.com/embed/22nd99SLgNA?si=2czDnpiVKMKV7E6j" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>",                     // ← ID do vídeo do YouTube (o que vem depois do v=)
